...
/*Reads the file from the saved location on disk
 Sends the file data to the frontend response as blob (binary data)
 Browser receives it as a downloadable attachment */
