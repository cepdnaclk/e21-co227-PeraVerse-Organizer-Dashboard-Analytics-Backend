...
const OverviewWidget: React.FC = () => {
  ...
  //allvisitor
  const [allBuildingsTotal, setAllBuildingsTotal] = useState<number>(0);
  ...
  useEffect(() => {
    ...
    async function fetchStats() {
      setLoading(true);
      // overviewwidget-fetch_______________________________________________________________________
      try {
        ...
        const [
          ...
          axios.get(`${baseURL}/all-visitors`), // all
        ]);
        ...
        // all
        setAllBuildingsTotal(allBuildingsTotalRes.data.total_visitors || 0);
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[{ label: "All Buildings Total", value: allBuildingsTotal, change: "+5%", icon: Users, color: "blue" },//all visitors
